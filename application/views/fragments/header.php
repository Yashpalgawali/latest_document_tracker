    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="nav-link" href="<?php echo base_url();?>Vendor">Add Vendor</a></li>
            <li><a class="nav-link" href="<?php echo base_url();?>Vendor/viewvendor">View Vendor</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Vendor Types</a>
          <ul class="dropdown-menu">
            <li><a class="nav-link" href="<?php echo base_url();?>Vendor/addvendortype">Add Vendor Type</a></li>
